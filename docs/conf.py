...
myst_html_meta = {
  ...
  "property=og:image": "https://github.com/bahadircakir/openpilot/blob/master/selfdrive/assets/img_spinner_comma.png",
  "property=og:image:url": "https://github.com/bahadircakir/openpilot/blob/master/selfdrive/assets/img_spinner_comma.png",
  "property=og:image:secure_url": "https://github.com/bahadircakir/openpilot/blob/master/selfdrive/assets/img_spinner_comma.png",
  "property=og:description": "openpilot Documentation",
  "property=twitter:card": "summary_large_image",
  "property=twitter:logo": "https://github.com/bahadircakir/openpilot/blob/master/selfdrive/assets/img_spinner_comma.png",
...
html_logo = 'https://github.com/bahadircakir/openpilot/blob/master/selfdrive/assets/img_spinner_comma.png'
